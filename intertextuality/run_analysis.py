'''
This suit of code loads in a corpus, identifies all intertextuality according
to set parameters and returns several summary visualizations.

You will need to install the python Levenshtein library for this to function
properly. You can do this using
pip install python-Levenshtein

This will run significantly slower on Windows computers because I have disabled
multithreading.
'''
...
##################################
# OPTIONS FOR CORPUS PREPERATION #
##################################
...
docs_for_viz = ["doyle_adventures_12_d", "doyle_adventures_8_d"]
